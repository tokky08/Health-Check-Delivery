...
insert into menu values(28, "ヨーグルトとりんご、野菜ジュース", "health_28.png", "morning", "high", 250, 0, 1, 0, 0, 0, 0, 0, "ヨーグルトで腸内環境を整えて、果実で加糖と酵素を、野菜ジュースでビタミンを摂取できます！");
insert into menu values(29, "ヨーグルトとパイナップル、野菜ジュース", "health_29.png", "morning", "high", 250, 0, 1, 0, 0, 0, 0, 0, "ヨーグルトで腸内環境を整えて、果実で加糖と酵素を、野菜ジュースでビタミンを摂取できます！");
insert into menu values(30, "ヨーグルトとバナナ、野菜ジュース", "health_30.png", "morning", "high", 250, 0, 1, 0, 0, 0, 0, 0, "ヨーグルトで腸内環境を整えて、果実で加糖と酵素を、野菜ジュースでビタミンを摂取できます！");
insert into menu values(31, "キノコの和風スパゲティとサラダ(レタス卵トマト)", "health_31.png", "lunch", "high", 600, 1, 0, 1, 0, 0, 0, 0, "キノコは低カロリーで、パスタは低GIでダイエット向き。トマトは血糖値を下げるのにも効果があります！");
insert into menu values(32, "胸肉のソテーとブロッコリー、オニオンスープ", "health_32.png", "lunch", "high", 600, 0, 0, 0, 0, 0, 0, 0, "鶏肉は低カロリーで高タンパク質。ダイエットにはもってこいです！コスパがいいのもgood!");
insert into menu values(33, "大根煮物(鶏肉とにんじん入り) と鯖の塩焼き、ご飯と味噌汁", "health_33.png", "lunch", "high", 660, 0, 0, 0, 0, 0, 0, 0, "大根やにんじんでビタミン摂取、鶏肉でタンパク質を摂取できます。バランスが取れた昼食を！");
insert into menu values(34, "つくねハンバーグ、ご飯と味噌汁、マカロニサラダ", "health_34.png", "dinner", "high", 700, 0, 0, 1, 0, 0, 0, 0, "つくねハンバーグは何と200kcal程度！低カロリーで美味しくいただけます！");
insert into menu values(35, "サラダスパゲッティ(蒸し鳥、野菜)とジャーマンポテト", "health_35.png", "dinner", "high", 700, 1, 0, 1, 0, 0, 0, 0, "ジジャガイモはビタミンを多く含み、熱に強いため、ビタミン摂取を非常に効率よく行えます！");
insert into menu values(36, "水炊き(胸肉、鳥ミンチ、白菜、ネギ、豆腐、椎茸)、ポン酢を添えて", "health_36.png", "dinner", "high", 600, 0, 0, 0, 0, 0, 0, 0, "水炊きはさまざまな野菜を取ることができ、豆腐でタンパク質も摂取できる。高タンパクで低カロリー、かつビタミンも取れる優れものです！");
